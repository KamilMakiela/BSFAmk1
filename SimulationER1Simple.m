...
function  [wyniki, pliki] = SimulationER1Simple(y, x, n, t, u, beta, iteracje, hand, objetosc, spalonych, restrykcje, mediana, priors)
t1 = clock;
...
for a2 = 1:liczba_plikow
    for a3 = 1:dlugosc_mat
        a1 = a1 + 1;
        [fi_B(1,a3), s_B(1,a3) , u, beta, mdd_d(1,a3), przepelnien] = GibbsER1Simple(y, x, n, t, u, beta, przepelnien, a1, restr_from, restr, par, mediana);
        b_B(:,a3) = beta;
        u_B(:,a3) = u;
