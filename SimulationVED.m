...
function  [wyniki, pliki] = SimulationVED(y, x, n, t, u, beta, iteracje, hand, objetosc, spalonych, restrykcje, mediana, priors)
t1 = clock;
...
for a2 = 1:liczba_plikow
    for a3 = 1:dlugosc_mat
        ...
        if a1 < (restr_from-1)
            switch ile_fi
                case 1
                    [st_fi, s, u, beta, mdd_d(1,a3), przepelnien] = GibbsVED1Simple(y, x, n, t, u, beta, par_rozkl, st_fi, przepelnien, a1, restr_from, restr, par, mediana);
                case 2
                    [st_fi, s, u, beta, mdd_d(1,a3), przepelnien] = GibbsVED2Simple(y, x, n, t, u, beta, par_rozkl, st_fi, przepelnien, a1, restr_from, restr, par, mediana);
                case 3
                    [st_fi, s, u, beta, mdd_d(1,a3), przepelnien] = GibbsVED3Simple(y, x, n, t, u, beta, par_rozkl, st_fi, przepelnien, a1, restr_from, restr, par, mediana);
                otherwise
                    disp('nieznany model VED');
            end
        else
            switch ile_fi
                case 1
                    [st_fi, s, u, beta, mdd_d(1,a3), przepelnien] = GibbsVED1Alt(y, x, n, t, u, beta, par_rozkl, st_fi, s, przepelnien, a1, restr_from, restr, par, mediana);
                case 2
                    [st_fi, s, u, beta, mdd_d(1,a3), przepelnien] = GibbsVED2Alt(y, x, n, t, u, beta, par_rozkl, st_fi, s, przepelnien, a1, restr_from, restr, par, mediana);
                case 3
                    [st_fi, s, u, beta, mdd_d(1,a3), przepelnien] = GibbsVED3Alt(y, x, n, t, u, beta, par_rozkl, st_fi, s, przepelnien, a1, restr_from, restr, par, mediana);
                otherwise
                    disp('nieznany model VED');
            end
        end
