...
if handles.user.ready2decom == 1
    choice = questdlg(...
        ...
        'Makiela, K., Marzec J., Pisulewski, A. (2017) - decomposes productivity change into technical, scale and efficiency change' ...
        }, ...
        'Decomposition menu', ...
        'Makiela (2014)', 'Makiela et al. (2017)', 'Makiela (2014)');
    ...
    msgbox('No model has been estimated. If you wish to decompose previous a estimation use the function in decompose.m (or decopmpose2.m) directly from the command line. ','No data for decomposition','error');
end
